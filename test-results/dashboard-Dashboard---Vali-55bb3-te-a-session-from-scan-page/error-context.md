...
- Name: dashboard.spec.ts >> Dashboard - Validate Flow >> should validate a session from scan page
- Location: e2e/dashboard.spec.ts:150:7
...
Call log:
  ...
  - waiting for locator('text=Pendente')
